...
#define explicit_bzero crypto_wipe
#define mbedtls_platform_zeroize crypto_wipe
...
/**
 * \def MBEDTLS_TIMING_CMBEDTLS_MD_SOME_PSA
 *
...
/* RSA OPTIONS */
#define MBEDTLS_RSA_GEN_KEY_MIN_BITS            2048 /**<  Minimum RSA key size that can be generated in bits (Minimum possible value is 128 bits) */
